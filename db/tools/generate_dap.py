...
dbconn = psycopg2.connect( "host='localhost' port=5432 dbname='tinydap' user='tinydap' password='tinydap'" )
dbconn.set_isolation_level(psycopg2.extensions.ISOLATION_LEVEL_AUTOCOMMIT)
dbc = dbconn.cursor(cursor_factory=psycopg2.extras.DictCursor)
